...
| Metric                | Value         |
|-----------------------|---------------|
| Total RTL lines       | 2,547         |
| Synthesized cells     | 1,004 (sky130)|
| Sequential FFs        | ~767          |
| Combinational modules | 5             |
| Sequential modules    | 5             |
| Target frequency (TT) | >10 MHz       |
| Worst slack (TT 1.8V) | +0.192 ns     |
| Worst slack (SS 1.28V)| -91.9 ns (advisory extreme corner) |
| Clock period assumed  | 10 ns         |
